...
const steps = [
  {
    ...
    description:
      "To begin sharing your content on OnlyFans, you'll need to create an account. It's free to sign up, and takes only a few moments.",
  },
  {
  ...
  {
    title: "Create Content & Promote Your OnlyFans",
    description:
      "Once you’ve started sharing content, let your followers on other social platforms know about your OnlyFans profile!",
  },
];
